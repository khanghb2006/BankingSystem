...
alter table Account
    ...
    add constraint DF_Account_AvailableBalance
        default 0 for available_balance;
    add constraint DF_Account_OpenedAt
...
alter table BankTransaction
    add constraint DF_BankTransaction_CreatedAt
        default getdate() for created_at;
    add constraint DF_BankTransaction_Status
        default 'Pending' for status;
    add constraint DF_BankTransaction_Fee
        default 0 for fee;
go
...
alter table OTP
    add constraint DF_OTP_CreatedAt
        default getdate() for created_at;
    add constraint DF_OTP_Verified
