    ...
    BEGIN TRY
        BEGIN TRANSACTION;
            ...
            IF dbo.fn_account_validate_id(@account_id) = 0
                THROW 86000, 'Invalid account ID.', 1;

            -- Validate account role
            IF dbo.fn_account_validate_role(@account_id, 'Employee') = 0
                THROW 86001, 'Account role must be Employee.', 1;
            ...
            IF @full_name IS NULL
                ...
                AND @gender IS NULL
                AND @address IS NULL
                THROW 86002, 'No fields provided for update.', 1;
            ...
            IF @@ROWCOUNT = 0
                THROW 86003, 'Failed to update employee profile.', 1;
